    ...
    for _, p := range thisProgram {
      ...
      for _, v := range videoProperties {
        ...
        switch(v) {
          ...
          case "hdtv":  quality = true
          case "sdtv":  quality = true
          case "uhdtv": quality = true
          case "3d":    quality = true
      ...
      for _, a := range audioProperties {
        ...
        switch(a) {
          ...
          case "stereo":  audio = "stereo"
          case "DD 5.1":  audio = "surround"
          case "Atmos":   audio = "surround"
          case "dubbed":  audio = "mono"
          case "mono":    audio = "mono"
        ...
        switch(audio) {
          ...
          case "stereo":    program.Audio.Stereo = "dolby digital"
          case "surround":  program.Audio.Surround = a
          case "mono":      program.Audio.Mono = "mono"
